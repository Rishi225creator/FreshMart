<%@include file="admin_header.jsp"%>
    ...
    <div id="admin-side-fruit">
        <div>
            <h2 align="center" style="color:rgb(26, 187, 158);font-size:30px;font-weight:bold">FRUITS LIVE DESCRIPTION</h2>
        </div>
        <div>
            <table border="2px">
                <tr>
                ...
                <tr>
                    ...
                    <td><button><a href="updateproduct?id=<%=curr.getId()%>">Edit</a></button></td>
                    <td><button><a href="deleteproduct?id=<%=curr.getId()%>">Delete</a></button></td>
                </tr>
                	<%}
                }%>
            </table>
